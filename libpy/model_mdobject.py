    ...
    def insert(self):
        ...
        try:
            ...
            cur.execute("INSERT INTO mdobject \
              ...
              (?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
                        (self.objname, self.objdesc, self.scale, self.group_list[0], self.group_list[1],
                         self.group_list[2], self.group_list[3], self.group_list[4], self.group_list[5],
                         self.group_list[6],
    ...
    def find_all(self):
        ...
        for row in cur.execute(sql):
            mdobject = MdObject(id=row[0], objname=row[1], objdesc=row[2], scale=row[3], dataset_id=row[4],
                                group1=row[5], \
                                group2=row[6], group3=row[7], group4=row[8], group5=row[9], group6=row[10],
                                group7=row[11], group8=row[12], \
